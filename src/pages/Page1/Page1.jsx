...
function Page1(props) {
  ...
  return (
    <div>
        ...
        >
          <div className="bg-gray-50 ">
            <h2>
              ...
              >
                <span className="text-xl font-bold text-gray-700 uppercase dark:bg-gray-700 dark:text-gray-400">
                  휴학생도 킹고코인을 사용하고 받을 수 있나요?
                </span>
                <svg
                  className={`w-6 h-6 ${section1Open ? "rotate-180" : ""}`}
                  fill="currentColor"
                  viewBox="0 0 20 20"
            ...
            {section1Open && (
              <div className="p-5 dark:bg-gray-900">
                <p className="mb-2 text-gray-500">
                  킹고코인 포인트는 AWS, GPU 개인 사용 크레딧, IT 기기대여,
                  세미나실 사용에 사용 등에 사용될 수 있으며, 코리아챌린지와
                  글로벌챌린지를 비롯한 각종 학과내 행사에 있어서 선발 기준에
                  적용될 수 있습니다.
                </p>
              </div>
            )}
            ...
            <h2>
              ...
              >
                ...
                <svg
                  className={`w-6 h-6 ${section2Open ? "rotate-180" : ""}`}
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
      ...
      <div>
        <div className="text-3xl font-bold pl-16 pb-5 pt-10">
          코인을 더 모으고 싶다면?
        </div>
        <div className="flex justify-center flex-nowrap gap-10">
          <div className=" bg-gray-50 p-5">
            <a href="https://mrdang.cs.skku.edu/">온라인 명륜당</a>
          </div>

          <div className=" bg-gray-50 p-5">
            <a href="https://itglobal.cs.skku.edu/login">글로벌 IT 강연</a>
          </div>
          <div className=" bg-gray-50 p-5">
